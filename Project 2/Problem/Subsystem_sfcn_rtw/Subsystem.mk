...
MODEL              = Subsystem
MODULES            = Subsystem_sf_data.c rtGetInf.c rtGetNaN.c 
...
MASTER_ANCHOR_DIR  = 
START_DIR          = D:\Data\Academic\Courses\Undergrad courses\Industrial Control\Lecture notes\Projects\ReactionCurve\Matlab\Source Codes\C-code model
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = ode45.c
NUMST              = 3
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=Subsystemlib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
MEX_OPT_FILE       = -f C:\Users\Modeer\AppData\Roaming\MATHWO~1\MATLAB\R2013b\mexopts.bat
COMPUTER           = PCWIN64
VISUAL_VER         = 11.0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Subsystem_sfcn_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\Data\Academic\Courses\Undergrad courses\Industrial Control\Lecture notes\Projects\ReactionCurve\Matlab\Source Codes\Simulink
